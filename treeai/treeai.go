...
func CreateWorktree(worktreeName string, silent bool, windowCommands []string, prompt string) {
	...
	if err := tmux.CreateAndSwitchSession(sessionName, worktreePath, windowCommands, prompt); err != nil {
